                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <ul id="menu-pricing" class="menu-price">
                            <li class="item dinner">
                                ...
                                <a href="#">
                                    <img src="{{ asset('frontend/images/food1.jpg') }}" class="img-responsive"
                                        alt="Food">
                            ...
                            <li class="item breakfast">
                                ...
                                <a href="#">
                                    <img src="{{ asset('frontend/images/food2.jpg') }}" class="img-responsive"
                                        alt="Food">
                                    <div class="menu-desc">
                                        <span>
                                            <h3>Prawn Dish</h3>
                            ...
                            <li class="item desert">
                                ...
                                <a href="#">
                                    <img src="{{ asset('frontend/images/food3.jpg') }}" class="img-responsive"
                                        alt="Food">
                                    <div class="menu-desc">
                                        <span>
                                            <h3>Salad Dish</h3>
                            ...
                            <li class="item breakfast special">
                                ...
                                <a href="#">
                                    <img src="{{ asset('frontend/images/food4.jpg') }}" class="img-responsive"
                                        alt="Food">
                                    <div class="menu-desc">
                                        <span>
                                            <h3>Prawn Dish</h3>
                            ...
                            <li class="item breakfast">
                                ...
                                <a href="#">
                                    <img src="{{ asset('frontend/images/food5.jpg') }}" class="img-responsive"
                                        alt="Food">
                                    <div class="menu-desc">
                                        <span>
                    ...
                    <div class="section-content">
                        ...
                        <div class="section-description">
                            ...
                            <p class="section-content-para">
                                beautiful, warm, living object looked so fragile, so delicate, that if you touched it
                                with a finger it would crumble and fall apart. Seeing this has to change a man. Where
                                ignorance lurks, so too do the frontiers of discovery and imagination.Astronomy compels
                                the soul to look upward, and leads us from this world to another. Curious that we spend
                                more time congratulating people who have succeeded than encouraging people who have not.
