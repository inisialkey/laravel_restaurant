        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <img id="logo" src="{{ asset('frontend/images/logo_utama.png') }}" class="logo img-responsive">
                </a>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="copyright text-center">
                        <p>
                            &copy; Copyright, 2019 <a href="https://www.facebook.com/Zaedoksz1234">Oki.</a>
                        </p>
                    </div>
                </div>
            </div>
